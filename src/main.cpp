...
//     vector<string> file_list = {"file_1.csv"};
//     vector<string> out_list = {"file1"};
...
//     res = hw_kmeans(dataset, num_clusters, threshold, num_iterations, numCols, 60000, "random", 0);
...
//     cout << res.loop_counter << " " << res.num_dist << " " << res.runtime << " " << res.sse << endl;
...
//     res = dchw_kmeans(dataset, num_clusters, threshold, num_iterations, numCols, 60000, "random", 0);
